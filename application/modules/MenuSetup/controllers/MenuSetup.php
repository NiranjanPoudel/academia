...
class MenuSetup extends OAS_Controller {
	...
	public function index(){
		...
		if (!in_array($this->session->userdata('emp_id'), MENU_SETUP_PERMISSION['empId'])){
			show_error("You Don't Have Authorization For Menu Setup. Reporting To System.", 403, 'Illegal Activity !!');
		}
